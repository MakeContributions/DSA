...
1) Calculate pre sum for every row of the matrix
   ...
   3 11 21 22 25
   -4 -5 -4 3 -3
2) Same approach as kadane algorithms take any two coloumns of the matrix and calculate maximum subarray sum in the row array.
   for example betweem coloumn 0 and 1, the row array will be,
   [4, -19, 14, -9]
   find max subarray sum.
3) Do it for every pair of coloumn and find the maximum of all. And that will be the final answer.
