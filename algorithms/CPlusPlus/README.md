...
- [First negative element of every window of size k](Arrays/first-negative-element.cpp)
## Dynamic-Programming
...
- [Finding sqrt in Binarry search](Searching/sqrt-monotonic-binary-search.cpp)
