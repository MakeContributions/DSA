...
5. [Dfs traversal using stack](Graphs/dfs-through-stackdatastructure.cpp)
6. [Dfs traversal](Graphs/dfs-traversal.cpp)
7. [Number of connected components](Graphs/total-connected-components.cpp)
